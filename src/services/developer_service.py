...
from src.models.project_models import Developer, DeveloperLevel, DeveloperExpertise
...
class DeveloperService:
    ...
    async def get_developer_workload(self, developer: Developer) -> int:
        ...
        try:
            issues = self.github.search_issues(f'assignee:{developer.github_username} is:open')
